...
export default {
  ...
  computed:{
    links(){
      return[
        {icon: 'mdi-bank', text: 'Банковский сектор', route: '/BankList'},
        {icon: 'mdi-invoice-text-check-outline', text: 'Страховой сектор', route: '/Insurance'},
        {icon: 'mdi-cash-multiple', text: 'Рынок Ценных Бумаг', route: '/RCB'},
        {icon: 'mdi-domain', text: 'Микрофинансовые организации', route: '/MFO'},
        {icon: 'mdi-domain', text: 'Национальный Банк РК', route: '/NBRK'}
      ]
    },
    user(){
